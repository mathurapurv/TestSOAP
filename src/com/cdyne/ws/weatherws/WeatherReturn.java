...
public class WeatherReturn {
	...
	public String toString() {
		return "WeatherReturn [success=" + success + ", responseText="
				+ responseText + ", state=" + state + ", city=" + city
				+ ", weatherStationCity=" + weatherStationCity + ", weatherID="
				+ weatherID + ", description=" + description + ", temperature="
				+ temperature + ", relativeHumidity=" + relativeHumidity
				+ ", wind=" + wind + ", pressure=" + pressure + ", visibility="
				+ visibility + ", windChill=" + windChill + ", remarks="
				+ remarks + "]";
	}
